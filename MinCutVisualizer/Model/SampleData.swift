...
let vertex4 = Vertex(value: 7, index: 3)
let vertex5 = Vertex(value: 13, index: 4)
let vertex6 = Vertex(value: 5, index: 5)
let vertex7 = Vertex(value: 12, index: 6)
let vertex8 = Vertex(value: 22, index: 7)
